...
{
    public class MeleeInteractAttackStrategy : MeleeAttackStrategy
    {
        #region Members
            ...
            if (ownerCharacterModel.CurrentAttackedTarget.IsCharacter)
            {
                ...
                (
                    ...
                    operatedPointTriggeredCallbackAction: () => {
                        ...
                        AudioController.Instance.PlaySoundEffectAsync(AudioConstants.GENERAL_ATK_MELEE, cancellationToken).Forget();
