...
{
    public class RangedLazerProjectileInteractAttackStrategy : RangedInteractAttackStrategy
    {
        #region Members
        ...
        {
            AudioController.Instance.PlaySoundEffectAsync(AudioConstants.RANGE_LAZER_ATK, cancellationToken).Forget();
        }
