...
{
    public class MeleeSpawnFlailAttackStrategy : MeleeAttackStrategy
    {
        #region Members
        
        private static readonly string[] s_flailPrefabNames = new string[4]
        {
            "3002_flail_up_right_attack",
            "3002_flail_up_left_attack",
            "3002_flail_down_left_attack",
            "3002_flail_down_right_attack",
        };
