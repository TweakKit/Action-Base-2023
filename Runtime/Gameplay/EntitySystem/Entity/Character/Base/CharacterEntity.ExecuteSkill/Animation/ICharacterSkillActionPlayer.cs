...
namespace Runtime.Gameplay.EntitySystem
{
    ...
    public interface ICharacterSkillActionPlayer
    {
        ...
        void SetNewAnimationName(SkillType skillType, SkillActionPhase skillActionPhase, string newMappingName);
    ...
    public struct CharacterPlayedSkillAction
    {
        ...
        public CharacterPlayedSkillAction(SkillType skillType, SkillActionPhase skillActionPhase, Action eventTriggeredCallbackAction, Action endActionCallbackAction, float speedMultiplier = 1)
        {
