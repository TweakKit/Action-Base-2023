...
namespace Runtime.Tool.NameGenerator
{
    public static class NamingGenerator
    {
        #region Members

        private static List<string> s_generatedNames = new List<string>();
        ...
        public static string GetNameRandomly()
        {
            ...
            do
            {
                var nameTypeValues = Enum.GetValues(typeof(NameType));
                int randomNameTypeValueIndex = UnityRandom.Range(0, nameTypeValues.Length);
                var randomNameType = (NameType)nameTypeValues.GetValue(randomNameTypeValueIndex);
                randomName = GetNameByType(randomNameType);
            }
            while (s_generatedNames.Any(x => x == randomName));
            s_generatedNames.Add(randomName);
            return randomName;
        }

        public static void ClearCachedNames()
            => s_generatedNames.Clear();

        public static string GetNameByType(NameType nameType)
        {
            var nameTypeValue = (int)nameType;
            var generatedName = "";
            string[] firstName = new string[] { };

            if (nameTypeValue <= (int)NameType.MaleNewName)
            {
                if (nameType == NameType.FemaleOldName)
                {
                ...
                else if (nameType == NameType.FemaleNewName)
                {
                    firstName = new string[]
                    {
                ...
                else if (nameType == NameType.MaleOldName)
                {
                    firstName = new string[]
                    {
                ...
                else if (nameType == NameType.MaleNewName)
                {
                    firstName = new string[]
                    {
                ...
                generatedName = $"{firstName[UnityRandom.Range(0, firstName.Length)]} {secondName[UnityRandom.Range(0, secondName.Length)]}";
            }
            else if (nameType == NameType.FemaleFantasyName || nameType == NameType.MaleFantasyName)
            {
                if (nameType == NameType.FemaleFantasyName)
                {
                    firstName = new string[]
                    {
                ...
                else if (nameType == NameType.MaleFantasyName)
                {
                    firstName = new string[]
                    {
                ...
                string secondName = secondName0[UnityRandom.Range(0, secondName0.Length)] + secondName1[UnityRandom.Range(0, secondName1.Length)];
                generatedName = $"{firstName[UnityRandom.Range(0, firstName.Length)]} {secondName}";
            }
            else if (nameType == NameType.SciFiName)
            {
                ...
                {
                    "a", "e", "i", "", "a", "e", "i", "o", "u", "o", "u", "a", "e", "i", "o", "u", "oi", "ie", "ai", "ei", "eo", "ui"
                };
                string[] name5 = new string[]
                {
                    "ks", "l", "ls", "n", "d", "ds", "k", "ns", "ts", "x"
                };
                int r1 = UnityRandom.Range(0, name1.Length);
                int r2 = UnityRandom.Range(0, name2.Length);
                int r3 = UnityRandom.Range(0, name3.Length);
                int r4 = UnityRandom.Range(0, name4.Length);
                int r5 = UnityRandom.Range(0, name5.Length);
                while (name3[r3] == name1[r1] || name3[r3] == name5[r5])
                    r3 = UnityRandom.Range(0, name3.Length);
                if (name3[r3] == "")
                {
                    r4 = 0;
                }
                ...
                {
                    while (name4[r4] == "")
                        r4 = UnityRandom.Range(0, name4.Length);
                }
                generatedName = name1[r1] + name2[r2] + name3[r3] + name4[r4] + name5[r5];
            }
            else generatedName = "No Name";
